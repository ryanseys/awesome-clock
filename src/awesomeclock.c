/*
   ...
   "Awesome" Digital Watch Pebble App
...
PBL_APP_INFO(MY_UUID, "Awesome Clock", "Awesome Inc.", 0x2, 0x0, INVALID_RESOURCE, APP_INFO_WATCH_FACE);
...
void handle_second_tick(AppContextRef ctx, PebbleTickEvent *t) {
  ...
  static char timeText[] = "you're awesome! :D\n00:00:00"; // Needs to be static because it's used by the system later.
  ...
  string_format_time(timeText, sizeof(timeText), "you're awesome! :D\n%T", &currentTime); // it's true...
